...
class SelectHairColor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent_next.putExtra("product_url", "https://m.search.naver.com/search.naver?query=%EB%AF%B8%EC%9A%A9%EC%8B%A4")
        //색상 버튼
        ...
        natural_black.setOnClickListener {
            ...
            intent_next.putExtra("color", "natural black")
        ...
        neutral_blonde.setOnClickListener {
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "natural blonde")
            startActivity(intent_next)
            R = "169"
            G = "158"
            B = "125"
        ...
        natural_red.setOnClickListener {
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "natural red")
            startActivity(intent_next)
            R = "158"
            G = "115"
            B = "98"
        ...
        platinum.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "platinum")
            startActivity(intent_next)
            R = "200"
            G = "207"
            B = "220"
        ...
        furture_mist.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "furture mist")
            startActivity(intent_next)
            R = "142"
            G = "138"
            B = "126"
        ...
        luminous_blonde.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "luminous blonde")
            startActivity(intent_next)
            R = "236"
            G = "202"
            B = "179"
        ...
        misty_rose.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "misty rose")
            startActivity(intent_next)
            R = "223"
            G = "172"
            B = "184"
        ...
        burgundy_blush.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "burgundy blush")
            startActivity(intent_next)
            R = "117"
            G = "76"
            B = "103"
        ...
        vivacious_red.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "vivacious red")
            startActivity(intent_next)
            R = "158"
            G = "71"
            B = "62"
        ...
        mintcream_blonde.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "mintcream blonde")
            startActivity(intent_next)
            R = "166"
            G = "205"
            B = "200"
        ...
        dark_slate_gray.setOnClickListener {
            ...
            intent_next.putExtra("url", new_name)
            intent_next.putExtra("color", "dark slate gray")
            startActivity(intent_next)
            R = "62"
            G = "81"
            B = "101"
